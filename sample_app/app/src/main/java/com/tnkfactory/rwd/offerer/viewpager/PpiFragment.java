 ...
 */
public class PpiFragment extends Fragment {

    private View rootView;

    public static PpiFragment newInstance() {

        Bundle args = new Bundle();

        PpiFragment fragment = new PpiFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_ppi, container, false);
        return rootView;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        // AdListView 생성
        int adListViewId = 102; // 하나의 액티비티에서 오퍼월을 2개 이상 사용할 경우 각 오퍼월마다 중복되지 않도록 뷰 ID를 지정해주어야 합니다. (필수)
        AdListView offerwallView = TnkSession.createAdListView(getActivity(), customLayout, false, null, AdListType.PPI, adListViewId);
